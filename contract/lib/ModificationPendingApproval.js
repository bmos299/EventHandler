...
class ModificationPendingApproval {
     ...
     *
     * Constructor for a ModificationPendingApproval object that serves as entries within the modificationsPendingApproval array of a AITrustAsset object.
     *
     * @param {String} modFileName - Name for the new file being uploaded for this asset.
     * @param {String} modFileHash - Hash of the aitrust asset.
